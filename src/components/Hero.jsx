...
export default function Hero() {
  ...
  const toolsList = [
    { name: 'Job Ready Score', desc: '100 pt score', color: 'bg-amber', border: 'border-amber/30', emoji: '🎯' },
    { name: 'Mock Interview', desc: '35+ topics', color: 'bg-violet', border: 'border-violet/30', emoji: '🧠' },
    { name: 'AI Resume Studio', desc: '95% ATS pass rate', color: 'bg-green', border: 'border-green/30', emoji: '📄' },
    { name: 'LinkedIn Optimizer', desc: '3.5x more views', color: 'bg-cyan2', border: 'border-cyan2/30', emoji: '💼' },
    { name: 'AI Job Finder', desc: 'Should I Apply? Engine', color: 'bg-[#0053D6]', border: 'border-[#0053D6]/30', emoji: '🔍' },
    { name: 'Cover Letter AI', desc: '8-10 keywords', color: 'bg-fuchsia-500', border: 'border-fuchsia-500/30', emoji: '✉️' },
    { name: 'Job Tracker', desc: 'Kanban + List view', color: 'bg-emerald-500', border: 'border-emerald-500/30', emoji: '📊' },
    { name: 'GitHub Optimizer', desc: '100 pt score', color: 'bg-slate-400', border: 'border-slate-500/30', emoji: '🐙' },
  ];
