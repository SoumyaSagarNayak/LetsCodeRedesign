  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 h-16 w-full bg-[#0A0F1E]/82 backdrop-blur-md border-b border-violet/18 flex items-center justify-between px-6 md:px-12">
      ...
      <a href="#" className="flex items-center gap-3 group">
        <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-violet to-cyan flex items-center justify-center text-base shadow-[0_0_15px_rgba(124,58,237,0.3)] group-hover:shadow-[0_0_20px_rgba(0,229,255,0.5)] transition-all duration-200">
          💻
        </div>
      ...
      <div className="hidden md:flex items-center gap-4 font-body">
        <button className="text-white hover:text-white/80 border border-border px-4.5 py-1.5 rounded-lg text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-violet">
          Log In
        </button>
        <button className="bg-gradient-to-r from-violet to-violet2 hover:from-violet2 hover:to-violet text-white px-5 py-1.5 rounded-lg text-sm font-semibold shadow-[0_0_15px_rgba(124,58,237,0.3)] hover:shadow-[0_0_25px_rgba(157,92,255,0.5)] transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-cyan">
          Get Started Free
        </button>
      </div>
